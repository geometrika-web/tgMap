...
document
    .getElementById('back-href')
    .setAttribute('href', 'map.html' + localStorage.hash);
                ...
                PhotoSphereViewer.MarkersPlugin,
                {
                    ...
                    markers: [
                        ...
                        },
                        {
                            ...
                            content:
                                document.getElementById('crkvaMesihovina')
                                    .innerHTML
                        },
                        {
                            ...
                            content:
                                document.getElementById('bukovica').innerHTML,
                            style: {
                                maxWidth: '500px',
                                height: '150px',
                                color: 'white',
                                ...
                                //paddingLeft: '0.5rem',
                                background:
                                    'linear-gradient(#fff, #fff) no-repeat center bottom/1.5px 85%'
                                //padding: '0.5em 1em',
                                //borderRadius: '4px',
                        ...
                        },
                        {
                            ...
                            content:
                                document.getElementById('seonica').innerHTML,
                            style: {
                                maxWidth: '500px',
                                height: '150px',
                                color: 'white',
                        ...
                        },
                        {
                            ...
                            content:
                                document.getElementById('crvenice').innerHTML,
                            style: {
                                maxWidth: '500px',
                                height: '150px',
                                color: 'white',
                    ...
                    markers: [
                        {
                            ...
                            content:
                                document.getElementById('glizicaMlinica')
                                    .innerHTML
                        },
                        {
                            // mountain marker
